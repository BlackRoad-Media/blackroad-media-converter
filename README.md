...
**ulackroad media converter** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
```bash
curl -O https://raw.githubusercontent.com/BlackRoad-OS/blackroad-media-converter/main/blackroad-media-converter.sh
chmod +x blackroad-media-converter.sh
./blackroad-media-converter.sh
```
